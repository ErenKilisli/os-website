...
export const FILM_PROJECTS: Project[] = [
  {
    ...
    icon: '📁',
    description: 'Assistant Director on an upcoming feature film production based in Berlin.',
    tags: ['Feature Film', 'Assistant Director', 'Berlin', 'Upcoming'],
    links: [],
  },
  {
    id: 'raven-with-broken-wings',
    name: 'RAVEN WITH BROKEN WINGS',
    year: '2025',
    type: 'Short Film · Assistant Director',
    icon: '📁',
    description: 'Assistant Director on a Berlin-based production.',
    tags: ['Short Film', 'Assistant Director', 'Berlin'],
    links: [],
  },
  {
    id: 'redend',
    name: 'REDEND — MUSIC VIDEO',
    year: '2025',
    type: 'Music Video · Line Producer',
    icon: '📁',
    description: 'Line Producer on a music video production based in Berlin.',
    tags: ['Music Video', 'Line Producer', 'Berlin'],
    links: [],
  },
  {
    ...
    tags: ['Cinematics', 'Unreal Engine', 'Lighting', 'Camera', 'Istanbul'],
    links: [
      { label: 'Watch Cinematic', url: 'https://drive.google.com/file/d/1xL5qI-jqCTmLKcYju3eunqMI3opknEpB/view' },
    ],
  },
  {
    ...
    type: 'Short Film · Assistant Director',
    icon: '📁',
    description: 'Assistant Director. Assisted during shooting and production preparation.',
    tags: ['Short Film', 'Assistant Director', 'Production', 'Hatay'],
    links: [
  ...
  },
  {
    ...
    tags: ['Short Film', 'Director', 'Writer', 'EU Project', 'Hatay'],
    links: [],
  },
  {
    id: 'blood',
    ...
    tags: ['Short Film', 'Director', 'Writer', 'Festival Selection', 'Istanbul'],
    links: [],
  },
  {
    id: 'mcdonalds',
    ...
    tags: ['Commercial', 'Production Assistant', 'LAB34', 'Istanbul'],
    links: [
  ...
  },
  {
    ...
    tags: ['Music Video', 'Assistant Director', 'Milk Jack', 'Istanbul'],
    links: [
  ...
  },
  {
    ...
    tags: ['Short Film', 'Director', 'Writer', 'Festival', 'Istanbul'],
    links: [],
  },
]
