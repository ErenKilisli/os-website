...
import { FolderFilmIcon, FolderGameIcon, FolderEmptyIcon, SnowboarderPixelIcon, PaintBrushIcon } from './FolderIcons'
...
function IconGraphic({ icon }: { icon: IconState }) {
  ...
  if (icon.windowType === 'paint') return <PaintBrushIcon size={48} />
